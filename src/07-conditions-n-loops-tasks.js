...
function doRectanglesOverlap(rect1, rect2) {
  return (rect1.top + rect1.width > rect2.top) && (rect1.left + rect1.height > rect2.left);
}
...
function getDigitalRoot(num) {
  ...
  const digitSum = arr.reduce((acc, el) => acc + +el, 0);
  return digitSum < 9 ? digitSum : getDigitalRoot(digitSum);
}
